...
var app = {
	...
	initFrame: function()
	{
		...
		try{
			...
			app.win = cordova.InAppBrowser.open('http://colombo.vn/?page=Mobile.login&androidRegistrationId='+(app.oldRegId?app.oldRegId:'mobile'), '_blank', 'fullscreen=yes,location=no,zoom=no,status=no,toolbar=no,titlebar=no,disallowoverscroll=yes,allowInlineMediaPlayback=yes');
			app.win.show();
		}
		catch(e)
		{
